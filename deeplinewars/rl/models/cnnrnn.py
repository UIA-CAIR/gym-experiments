...
def model(state_size, action_size, learning_rate):
    ...
    model = Sequential()
    model.add(ConvLSTM2D(64, (1, 1), return_sequences=True, strides=(3, 3), data_format="channels_first", activation="relu", input_shape=(None, ) + state_size)) # (None, 2, 11, 11)
    model.add(ConvLSTM2D(64, (1, 1), return_sequences=True, strides=(2, 2), data_format="channels_first", activation="relu"))
